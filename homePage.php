                ...
                <ul class='navbar-nav menuItems'>
                  ...
                  <li class='nav-item dropdown'>
                    ...
                    <div class='dropdown-menu '>
                      ...
                      <a class='dropdown-item' href='./moneyTransfer.php' data-toggle='modal' data-target='#moneyTransfer'>Chuyển tiền</a>
                      <a class='dropdown-item' href='./historyTransfer.php' data-toggle='modal' data-target='#moneyTransfer'>Lịch sử giao dịch</a>
                    </div>
                  </li>
    ...
    <?php
        ...
        if($print['confirm'] === '0')
        {
          ...
          <div class='container'>
            ...
            <div class='modal fade' id='moneyTransfer' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel'
              aria-hidden='true'>
              <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                  ...
                  <div class='modal-body'>
                    <h3>Bạn cần phải xác nhận để sử dụng chức năng này</h3>
        ...
        else if($print['confirm'] === "1")
        {
            ...
            <div class='row'>
              <div class='card col-xl-4 col-lg-4 col-md-6 col-sm-12 border-0 mb-3'>
                ...
                <div class='card-footer text-primary border'>
                  <a href='./moneyTransfer.php' class='text-decoration-none'>Chuyển tiền</a>
                </div>
                <div class='card-footer text-primary border'>
                  <a href='./historyTransfer.php' class='text-decoration-none'>Lịch sử giao dịch</a>
                </div>
              </div>
